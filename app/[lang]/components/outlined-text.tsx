export default function OutlinedText({
  ...
  return (
    ...
    <div className="relative h-full w-full">
        ...
        <span className={`absolute h-full w-full flex align-center justify-center items-center font-londrina_outline text-black text-3xl lg:text-4xl`}>{children}</span>
    </div>
    </>
  );
}